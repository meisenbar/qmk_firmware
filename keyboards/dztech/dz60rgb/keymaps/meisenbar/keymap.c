...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        LT(1, KC_BSPC), KC_A,    KC_S,            KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,                  KC_ENT,
    ...
    [1] = LAYOUT(
        ...
        _______, _______, _______,   _______, _______, _______, KC_CALC, RALT(KC_Y), KC_INS,  RALT(KC_P), KC_PSCR, KC_SLCK, KC_PAUS, RESET,
        _______, RALT(KC_Q), RALT(KC_S), _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_GRV,          EEP_RST,
        _______,          _______, _______, _______, _______, _______, NK_TOGG, _______, _______, KC_END,  KC_RSFT, KC_VOLU, KC_MUTE,
        _______, _______, _______,                            TO(4),                     KC_MPLY, _______, KC_MPRV, KC_VOLD, KC_MNXT
    ),
    [2] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, RGB_SPI, RGB_SPD, _______,  KC_GRV,          EEP_RST,
